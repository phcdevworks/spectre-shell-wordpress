...
<main class="site-main container mx-auto px-4 py-8">
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class('bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow'); ?>>
                    ...
                    <div class="p-6">
                        <h2 class="text-2xl font-bold mb-2">
                            <a href="<?php echo esc_url(get_permalink()); ?>" class="text-gray-800 hover:text-blue-600">
                                <?php the_title(); ?>
                            </a>
                        </h2>
                        ...
                        <a href="<?php echo esc_url(get_permalink()); ?>" class="inline-block mt-4 text-blue-600 hover:text-blue-800 font-semibold">
    ...
    <?php else : ?>
        <div class="no-posts text-center py-12">
            <h2 class="text-3xl font-bold mb-4"><?php esc_html_e('No posts found', 'spectre-wordpress-themes'); ?></h2>
            <p class="text-gray-600"><?php esc_html_e('Sorry, no posts were found.', 'spectre-wordpress-themes'); ?></p>
        </div>
    <?php endif; ?>
</main>
